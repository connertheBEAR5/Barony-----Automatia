...
extern button_t* butDialogue;
extern button_t* butDialogueEditor;
extern button_t* butScripts;
extern button_t* butTextSourceScriptTester;
extern button_t* butHelp;
extern button_t* butAbout;
extern button_t* butEditorControls;
extern button_t* but3DMode;
extern button_t* but3DModels;
...
extern bool editor3DModelsEnabled;
extern int openwindow, savewindow, newwindow;
extern int slidery;
