...
#define ITEM_SLOT_INVENTORY_COUNT 32
#define ITEM_SLOT_INV_LAST ITEM_SLOT_INV_1 + (ITEM_SLOT_INVENTORY_COUNT - 1) * ITEM_SLOT_NUMPROPERTIES
#define ITEM_CHANCE 5
#define ITEM_SLOT_CATEGORY 6
#define ITEM_CUSTOM_SLOT_LIMIT ITEM_SLOT_INVENTORY_COUNT
#define ITEM_SLOT_NUM ITEM_SLOT_INV_LAST + ITEM_SLOT_NUMPROPERTIES
#define ITEM_SLOT_LEGACY_NUM ITEM_SLOT_INV_6 + ITEM_SLOT_NUMPROPERTIES
